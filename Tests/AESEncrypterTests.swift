...
//        let ivData = "1a f3 8c 2d c2 b9 6f fd d8 66 94 09 23 41 bc 04".hexadecimalToData()
//        let cipherText = try! encrypter.encrypt("Hello World!".data(using: .utf8)!, with: "header".data(using: .utf8)!)
