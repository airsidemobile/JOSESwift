...
class AESEncrypterTests: CryptoTestCase {
    ...
    func testEncrypting() {
        ...
        let cek = try! SecureRandom.generate(count: SymmetricKeyAlgorithm.AES256CBCHS512.keyLength)
        ...
        let keys = try! SymmetricKeyAlgorithm.AES256CBCHS512.retrieveKeys(from: cek)
