...
class ECCryptoTestCase: CryptoTestCase {
    ...
    let p256 = ECTestKeyData(
            ...
            expectedPrivateOctetString: Data(bytes: [
                0x12, 0xEA, 0x41, 0x29, 0x15, 0x4E, 0x48, 0x2E, 0x01, 0x92, 0xA5, 0x28, 0x89, 0x70, 0xAD, 0x56, 0x82,
                0x19, 0xBF, 0xC8, 0x25, 0x5E, 0xF2, 0x03, 0x0E, 0x4C, 0x1D, 0xCF, 0x46, 0x8A, 0x7E, 0x25
            ]),
            expectedPrivateBase64Url: "EupBKRVOSC4BkqUoiXCtVoIZv8glXvIDDkwdz0aKfiU",
            expectedXCoordinate: Data(bytes: [
